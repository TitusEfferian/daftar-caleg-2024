...
export declare type CalonLegislatifUpdateFormProps = React.PropsWithChildren<
  {
    ...
    onSubmit?: (
      fields: CalonLegislatifUpdateFormInputValues
    ) => CalonLegislatifUpdateFormInputValues;
...
>;
export default function CalonLegislatifUpdateForm(
  props: CalonLegislatifUpdateFormProps
): React.ReactElement;
