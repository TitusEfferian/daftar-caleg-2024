...
export default function CalonLegislatifCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setImg_src(initialValues.img_src);
    setEx_koruptor(initialValues.ex_koruptor);
    setEx_koruptor_source(initialValues.ex_koruptor_source);
    setDapil(initialValues.dapil);
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "CalonLegislatifCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
